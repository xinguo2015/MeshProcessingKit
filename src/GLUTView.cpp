...
namespace xglm {
	...
	// display frame rates
	///////////////////////////////////////////////////////////////////////////////
	float GLUTView::getFPS()
	{ 
		return _frameCount/_timer.getElapsedTime();
	}
	
	void GLUTView::updateFrameCount()
	{
	...
	void keyf(GLUTView *v, unsigned char k, int x, int y)
	{
		v->cbKeyboard(k,x,y);
	}

	void GLUTView::initialize()
	{
